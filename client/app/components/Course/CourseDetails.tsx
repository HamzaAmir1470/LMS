...
const CourseDetails = ({ data }: Props) => {
  ...
  // Ensure it doesn't display negative percentages if estimatedPrice is lower than price
      ...
      <div className="w-full flex flex-col-reverse 800px:flex-row">
        <div className="w-full 800px:w-[65%] 800px:pr-5">
          ...
          <div className="pt-2">
            {data?.benefits?.map((item: any, index: number) => (
              <div className="w-full flex items-start py-2" key={index}>
                ...
                {/* Text Container aligned outside of the icon div */}
          ...
          <div className="pt-2">
            ...
            <div className="w-full">
              <h1 className="text-[25px] font-Poppins">Course Details</h1>
            ...
            <div className="w-full">
              <div className="800px:flex items-center">
                ...
                <div className="mt-2 mb-2 800px:mb-[unset]">
                  ...
                  (item: any, index: number) => (
                    <div className="w-full pb-4" key={index}>
                      <div className="flex">
                        ...
                        <div className="hiidden 800px:block pl-2">
        ...
        <div className="w-full 800px:w-[35%] relative">
          <div className="sticky top-[100px] left-0 z-50 w-full">
            ...
            <div className="flex items-center">
              <h1>{data.price === 0 ? "Free" : data.price + "$"}</h1>
            ...
            <p className="pb-3 800px:pb-1  text-black dark:text-white">
              . Premium support on course content
            </p>
          </div>
        </div>
      </div>
